...
export const InferredDescription = z.object({
  address: z.union([z.string(), z.null()]).meta({ description: "postal address" }),
...
export type InferredDescription = z.infer<typeof InferredDescription>;
